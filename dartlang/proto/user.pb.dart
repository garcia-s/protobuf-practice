...
class NewUser extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NewUser', createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  NewUser copyWith(void Function(NewUser) updates) => super.copyWith((message) => updates(message as NewUser)) as NewUser;
